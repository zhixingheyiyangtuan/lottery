...
#define kWeatherGeneralH  SCREEN_ADJUST(100)
...
@interface WeatherViewController () <UIScrollViewDelegate, SettingCityControllerDelegate, WeatherToolBarDelegate, SRLocationToolDelegate, AddCityControllerDelegate>
...
-(void)loadView {
   ...
   // self.navigationItem.title = @"天气查询";
     self.navigationItem.leftBarButtonItem =  [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"彩票类_04"]  style:UIBarButtonItemStylePlain target:self action:@selector(showMenuList)];
...
- (void)setupWeatherToolBar {
    ...
    [self.view addSubview:({
       ...
       // weatherToolBar.backgroundColor = [UIColor greenColor];
        weatherToolBar.frame = CGRectMake(0, SCREEN_HEIGHT - SCREEN_ADJUST(49) - SCREEN_ADJUST(75), SCREEN_WIDTH, SCREEN_ADJUST(49));
...
- (void)setupWeatherGeneralInfoView {
    ...
    [self.view addSubview:({
        ...
        //weatherGeneralInfoView.backgroundColor = [UIColor redColor];
...
#pragma mark --  set  WeatherDetail --
- (void)setupWeatherDetailInfoView {
    
    [self.view addSubview:({
        CGFloat weatherDetailInfoViewY     = kWeatherGeneralH + SCREEN_ADJUST(-40);
        CGFloat weatherDetailInfoViewH     = SCREEN_HEIGHT - weatherDetailInfoViewY - kButtomContainerH - SCREEN_ADJUST(75);
        _weatherDetailInfoView             = [[WeatherDetailInfoView alloc] init];
        
        //_weatherDetailInfoView.backgroundColor = [UIColor yellowColor];
        
        _weatherDetailInfoView.scrollEnabled = NO;
...
- (void)swipeGeneralInfoViewUP {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        _weatherGeneralInfoView.frame = CGRectMake(SCREEN_ADJUST(20), SCREEN_ADJUST(-40), kWeatherGeneralW, kWeatherGeneralH);
...
#pragma mark -- bang ding shu ju (2) --
